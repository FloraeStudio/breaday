        ...
        <div class="product-info-body scroll-reveal">
          ...
          <div class="product-qty-row">
            <div class="qty-stepper">
              <button type="button" class="qty-btn" data-action="dec" aria-label="減少數量">−</button>
              <input type="number" class="qty-input" id="pd-qty" value="1" min="1" inputmode="numeric">
              <button type="button" class="qty-btn" data-action="inc" aria-label="增加數量">＋</button>
            </div>
            <button type="button" class="btn btn-accent product-add-btn" id="pd-add-btn">加入購物車</button>
          </div>
